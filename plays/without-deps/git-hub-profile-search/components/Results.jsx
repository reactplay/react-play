          ...
          <div className="nirban-github-profile-results-body">
            <div>
              <div className="nirban-github-profile-details">
                <img
                  alt={`${results.name}`}
                  className="nirban-github-profile-avatar"
                  src={`${results.avatar_url}`}
                />
                <a href={`${results.html_url}`} rel="noreferrer" target="_blank">
                  <h2 className="nirban-github-profile-link">
              ...
              <div className="nirban-github-profile-results-info">
                <div>
                  {results.bio === '' ? (
                    ...
                    <h2 className="nirban-github-profile-bio">
                      <strong>Bio:</strong> {results.bio}
                    </h2>
                  )}
                  {results.location === '' ? (
                    ''
                  ) : (
                    <p className="nirban-github-profile-location">
                  ...
                  {results.twitter_username === '' ? (
                    ...
                    <p className="nirban-github-profile-twitter">
                  ...
                  <ul className="nirban-github-profile-socials">
                    <li>
                      <strong>{results.followers}</strong> Followers
                    </li>
                    <li>
                      <strong>{results.following}</strong> Following
                    </li>
                    <li>
                      <strong>{results.public_repos}</strong> Repos
                    </li>
                  </ul>
                </div>
                <div>
                  <h2 className="nirban-github-profile-repos-heading">Latest repositories</h2>
