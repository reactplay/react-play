...
const GuideModal = () => {
  ...
  return (
    <div className="flex justify-end ">
      ...
      >
        <Box className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[90vw] h-[60vh] overflow-y-auto sm:w-[50vw] sm:h-[70vh] bg-white/95 shadow-2xl p-4 rounded-lg">
          <Typography
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            ...
            <br />
            <span>
              You can set the timer ⏱️ in <strong>three modes</strong>, or even set a{' '}
              <strong>custom timer</strong> to fit your specific needs. Once you turn on the timer,
              you can see it in the title of your browser tab.
            </span>
            <br />
            <br />
            <span>
              ...
              "get back to work" 💻 based on your timer mode. If the timer is set for five minutes
              or less, it's time for <strong>rest</strong> , otherwise, it's time for get back to{' '}
