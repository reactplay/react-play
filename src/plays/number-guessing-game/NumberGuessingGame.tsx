...
function NumberGuessingGame(props:any) {
  ...
  return (
        ...
        <div className="container">
          <h1>GUESS THE NUMBER: A GAME</h1>
            <input type="number" id='guessedNumber' min={1} max={100}/>
            <div className="buttons">
              <button className='btn' onClick={handleClick}>Guess</button>
            ...
            {result==='equal' && (<React.Fragment><Message message='Congratulations! You guessed it right'/> <Score guessCount={guessCount}/></React.Fragment>)}
        </div>
      </>
  );
}
