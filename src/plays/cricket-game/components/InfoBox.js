...
export default function InfoBox({ matchInProgress, gameState }) {
  ...
  return (
    <div className="info-box w-1/2 md:w-3/5 h-4/5 bg-slate-200 rounded-[10px] md:rounded-[20px] flex flex-col justify-center items-center text-center text-sm md:text-lg font-main opacity-0 py-1 px-2 leading-3 md:leading-7">
      {matchInProgress &&
