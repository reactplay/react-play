...
export default function ScorePanel(props) {
  ...
  return (
    <div className="score-panel absolute h-[11%] md:h-[8.5%] bottom-[4px] rounded-[20px] flex flex-col md:flex-row items-center justify-evenly bg-white overflow-hidden z-[60]">
      <div className="w-full md:w-3/5 h-1/2 md:h-full flex flex-row items-center justify-evenly space-x-4 md:ml-5 ml-8">
        <div
          className={classNames(
            ...
            'font-main font-semibold flex items-center justify-center opacity-0 text-xs md:text-base',
